...
ACCOUNT_LOCKED_SLACK_BODY='{"blocks":[{"type":"header","text":{"type":"plain_text","text":"🔒 Account Locked!","emoji":true}},{"type":"section","text":{"type":"mrkdwn","text":"Someone tried to log in *{{context.value}} times* with the wrong password and got *locked out*. 🚫\n\n🌐 The same IP address kept hammering the login — this looks like a brute force attack.\n👤 The account has been locked automatically to prevent unauthorized access.\n\n*Check Kibana for the exact user ID and IP address* 👇"}},{"type":"context","elements":[{"type":"mrkdwn","text":"🔍 Index: `sim-auth-brute-force` | Scenario: auth-brute-force"}]}]}'

REPEATED_FAILURES_SLACK_BODY='{"blocks":[{"type":"header","text":{"type":"plain_text","text":"🚨 Possible Break-in Attempt!","emoji":true}},{"type":"section","text":{"type":"mrkdwn","text":"Someone has tried the wrong password *{{context.value}} times* in the last 5 minutes. 😬\n\n🔑 They keep guessing — this could be an automated brute force attack.\n⚠️ If this continues, the account will be locked automatically.\n\n*Open Kibana to see which user and IP is being targeted* 👇"}},{"type":"context","elements":[{"type":"mrkdwn","text":"🔍 Index: `sim-auth-brute-force` | Scenario: auth-brute-force"}]}]}'
