...
# 2. Delete Kibana saved objects for this scenario
# GET all dashboards matching title, DELETE each
...
# 3. Delete alert rules for this scenario
...
5. `visualization` — Scenario Metric A (scenario-specific, see table below)
...
Fill in real fields from implementor spec for each scenario.
