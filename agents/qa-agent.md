...
**4c.** Field mapping check per scenario — verify key fields are indexed with correct types:
```bash
...
**5d.** Dashboard panel count per scenario:
```bash
